...
/// @title SoulRendererV2Domain - reveal renderer (own-domain base after the 27-jul Vercel outage; NEVER a platform URL again) for Cubist Souls
...
contract SoulRendererV2Domain is ISoulRenderer {
    string private constant BASE = "https://cubistsouls.com/api";
